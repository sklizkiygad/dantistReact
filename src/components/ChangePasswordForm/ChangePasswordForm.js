...
import {checkPassword, checkRepeatPassword} from "../CheckInputFunctions/CheckInputFunctions";
        ...
        <section>
            ...
            <form className="form-section" onSubmit={onChangePassword}>
                ...
                <div className="form-section__input-block">
                    <label ref={inputPasswordLabelRef} className="form-section__input-block__label">Новый пароль</label>
                    <div className="form-section__input-block__pass">
                        <input type="password"  placeholder="Введите пароль" ref={inputPasswordRef} onChange={setPassword}/>
                        <img src={eyeImg} alt="eye" onClick={(e)=>setPasswordText(inputPasswordRef)}/>
                    </div>
                </div>

                <div className="form-section__input-block">
                    <label ref={inputRepeatPasswordLabelRef} className="form-section__input-block__label">Повторите пароль</label>
                    <div className="form-section__input-block__pass">
                        <input type="password" placeholder="Повторите пароль" ref={inputRepeatPasswordRef} onChange={setRepeatPassword}/>
                        <img src={eyeImg} alt="eye" onClick={(e)=>setPasswordText(inputRepeatPasswordRef)}/>
                    </div>
                </div>
