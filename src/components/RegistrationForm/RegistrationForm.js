        ...
        <section>
            ...
            <form className="form-section" onSubmit={onRegisterFormSubmit}>
                ...
                <div className="form-section__input-block">
                    ...
                    <input ref={inputFirstNameRef} type="text" placeholder="Введите фамилию" onChange={(e)=>setSecondName(e.target.value)}/>
                </div>

                <div className="form-section__input-block">
                    <label ref={inputSecondNameLabelRef}>Имя</label>
                    <input ref={inputSecondNameRef} type="text" placeholder="Введите имя" onChange={(e)=>setFirstName(e.target.value)}/>
                </div>

                <div className="form-section__input-block">
                    <label ref={inputFatherNameLabelRef}>Отчество</label>
                    <input ref={inputFatherNameRef} type="text" placeholder="Введите отчество" onChange={(e)=>setFatherName(e.target.value)}/>
                </div>
                ...
                <div className="form-section__input-block">
                    ...
                    <div className="form-section__input-block__pass">
                        <input ref={inputPasswordRef} type="password" ref={inputPasswordRef} placeholder="Введите пароль" onChange={(e)=>setPassword(e.target.value)}/>
                ...
                <button className="main-button" type="submit">Зарегистрироваться</button>
